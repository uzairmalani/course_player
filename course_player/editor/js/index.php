...
<head>
    ...
    <body>
      ...
      <div id="mySidenav" class="sidenav">
        ...
        <button id="addModule" data-rel="1"* class="btn btn-warning" onclick="wirteData()">Add Module</button>
        <button class="btn btn-warning " id="full-width-btn">
      ...
      <script>
        ...
        var firebaseConfig = {
          apiKey: "AIzaSyAHPO3d4-RiHRs4PhPknk8uMujwQYq08Ik",
          authDomain: "custom-editor.firebaseapp.com",
          databaseURL: "https://custom-editor.firebaseio.com",
          projectId: "custom-editor",
          storageBucket: "custom-editor.appspot.com",
          messagingSenderId: "431877800262",
          appId: "1:431877800262:web:83df57a11b4441e3cae547",
          measurementId: "G-P58FB0YNZE"
        };
        // Initialize Firebase
        ...
        function wirteData(){
          firebase.database().ref("custom-editor").set({
